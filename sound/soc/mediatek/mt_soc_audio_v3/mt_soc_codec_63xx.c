...
#include "AudDrv_Gpio.h"
//add by wq 
#define AW8155_MODE_CTRL //wq
/*
 if you want to change the mode of amp you can go to 
 arch/arm/config/projectxxx to change macros(CONFIG_AW8155AF_MODEX_CTRL) to you want. 
 */
//wq	#define	AW8155AF_MODE1_CTRL
//wq 	#define	AW8155AF_MODE2_CTRL
//wq	#define	AW8155AF_MODE3_CTRL //2016.11.18
//wq	#define	AW8155AF_MODE4_CTRL
#define SPK_EN 64

//wq static void aw8155_contrl_mode(void);
...
#ifdef AW8155_MODE_CTRL
//wq #define SPK_EN 64
static void aw8155_contrl_mode(void)
{
#ifdef CONFIG_AW8155AF_MODE1_CTRL
		gpio_request(SPK_EN,"spk_en");
		gpio_direction_output(SPK_EN,1);
		udelay(2);
		gpio_set_value(SPK_EN,1);  //pull up
		udelay(1000);
		gpio_free(SPK_EN);
#endif

#ifdef CONFIG_AW8155AF_MODE2_CTRL
		gpio_request(SPK_EN,"spk_en");
		gpio_direction_output(SPK_EN,1);
		udelay(2);
		gpio_set_value(SPK_EN,1);  //pull up
		udelay(2);
		gpio_set_value(SPK_EN,0);  //pull down
		udelay(2);
		gpio_set_value(SPK_EN,1);  //pull up
		udelay(1000);
		gpio_free(SPK_EN);
...
#ifdef CONFIG_AW8155AF_MODE3_CTRL
		gpio_request(SPK_EN,"spk_en");
		gpio_direction_output(SPK_EN,1);
		udelay(2);
		gpio_set_value(SPK_EN,1);  //pull up
...
#ifdef CONFIG_AW8155AF_MODE4_CTRL
		gpio_request(SPK_EN,"spk_en");
		gpio_direction_output(SPK_EN,1);
		udelay(2);
		gpio_set_value(SPK_EN,1);  //pull up
...
#else
//wq add for the aw8155af  
#ifdef AW8155_MODE_CTRL
		aw8155_contrl_mode();//wq 
#endif
//wq add end
...
//wq add		
#ifdef AW8155_MODE_CTRL
		gpio_request(SPK_EN,"spk_disable");
		gpio_direction_output(SPK_EN,1);
		udelay(2);
		gpio_set_value(SPK_EN,0);  //pull down
		udelay(2000);
