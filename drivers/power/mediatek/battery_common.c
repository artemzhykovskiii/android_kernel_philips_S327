...
static void kpoc_charging_led(void);//add by wq
#endif
/* ////////////////////////////////////////////////////////////////////////////// */
...
/*wq add for kpoc led turn on slowly
 s318 ISINK 0 RED 
      ISINK 1 GREEN
 s327 ISINK 0 GREEN
      ISINK 1 RED 
 */
#ifdef CONFIG_MTK_KERNEL_POWER_OFF_CHARGING
static void kpoc_charging_led(void)
{
	if(upmu_is_chr_det() == KAL_TRUE && g_platform_boot_mode == KERNEL_POWER_OFF_CHARGING_BOOT){

		if (strcmp(CONFIG_ARCH_MTK_PROJECT, "tpv6737m_35g_n_s327") == 0) {
			if(BMT_status.UI_SOC >= 90){//green
				...
				pmic_set_register_value(PMIC_ISINK_CH0_STEP, 3);
			...
			if(BMT_status.UI_SOC < 90){//red
				...
				pmic_set_register_value(PMIC_ISINK_CH1_STEP, 3);
...
static void mt_kpoc_power_off_check(void)
{
	...
	kpoc_charging_led();//add by wq for kpoc charging led turn on slowly
#endif
}
