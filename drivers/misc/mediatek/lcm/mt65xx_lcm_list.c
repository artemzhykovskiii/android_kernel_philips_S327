...
#if defined(SKI550B30_HD720_DSI_VDO_TPV)
	&ski550b30_hd720_dsi_vdo_tpv_lcm_drv,
#endif
//add by wq start
#if defined(LI9881C_HD720_DSI_VDO_TPV)
	&li9881c_hd720_dsi_vdo_tpv_lcm_drv,
#endif

#if defined(ILI9881C_HD720_DSI_VDO_SKI)
	&ili9881c_hd720_dsi_vdo_ski_lcm_drv,
#endif

#if defined(ILI9881C_HD720_DSI_VDO_AKJ)
	&ili9881c_hd720_dsi_vdo_akj_lcm_drv,
#endif
#if defined(HX8394D_HD720_DSI_VDO_TPV)
	&hx8394d_hd720_dsi_vdo_tpv_lcm_drv,
	#endif
#if defined(HX8394D_HD720_DSI_VDO_TPV_NEW)
	&hx8394d_hd720_dsi_vdo_tpv_new_lcm_drv,
	#endif
#if defined(HX8394F_HD720_DSI_VDO_TPV)
	&hx8394f_hd720_dsi_vdo_tpv_lcm_drv,
	#endif
//end 
