...
static LCM_setting_table_V3 lcm_initialization_setting_kd[] = {
	...
	{0x15,0x00,1,{0x80}},//LANESEL--0x80(4lane)or0x00(3lane)
	{0x15, 0x6C,1,{0x15}},
	{0x15, 0x6E,1,{0x2B}},
	{0x15, 0x6F,1,{0x31}},
	{0x15, 0x8D,1,{0x15}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_frontporch				= 150; //120;  //;
...
#else
	params->dsi.PLL_CLOCK =  275; //222;  //220; //this value must be in MTK suggested table: 920MHz MIPI_CLK /2 =460
#endif
#else
...
LCM_DRIVER ski550b30_hd720_dsi_vdo_tpv_lcm_drv= 
{
	.name	        = "ski550b30_hd720_dsi_vdo_tpv",
