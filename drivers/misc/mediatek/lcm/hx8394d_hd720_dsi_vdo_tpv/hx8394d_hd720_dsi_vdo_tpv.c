...
void init_lcm_registers(void)
{
	...
	data_array[1] = 0x008373BA;//lean NUMBER
	dsi_set_cmdq(data_array, 2, 1);
	MDELAY(1);
	...
	MDELAY(1);
	data_array[0] = 0x00023902;
	data_array[1] = 0x000005CC;//cc direction + 09 / - cc  05
	dsi_set_cmdq(data_array, 2, 1);
	MDELAY(1);
	data_array[0] = 0x00023902;
...
LCM_DRIVER hx8394d_hd720_dsi_vdo_tpv_lcm_drv= 
{
	.name	        = "hx8394d_hd720_dsi_vdo_tpv",
