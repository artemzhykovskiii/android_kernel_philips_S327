...
static imgsensor_info_struct imgsensor_info = { 
	...
	.checksum_value = 0x6933f494,//0x7b67575d,//0xa340b362,
	
	.pre = {
		.pclk = 288000000,				//record different mode's pclk
		.linelength = 6080,	//6080/2368*10000 =25676
		.framelength = 1572,
		.startx = 0,
		.starty = 0,
	...
	.cap = {
		.pclk = 288000000,
		.linelength = 3800,		//3800/2368*10000 =16048
		.framelength = 2520,
		.startx = 0,
		.starty = 0,
	...
	.normal_video = {
		.pclk = 288000000,				//record different mode's pclk//3800/2368*10000 =16048
	 ...
	 .hs_video = {
        .pclk = 88000000,
        .linelength = 3800,				//record different mode's linelength//3800/2880*10000 =13195
    ...
    .slim_video = {
       .pclk = 88000000,
		.linelength = 3800,//3800/2880*10000 =13195
		.framelength = 836,
		.startx = 0,
		.starty = 0,
...
void Hi843B_Sensor_OTP_info(void)
{
    ...
    switch (info_flag)
  {
    ...
    infocheck = HI843B_Sensor_OTP_read(0x020e);   //020f  20160524
      break;
    case 0x02:
    ...
    infocheck = HI843B_Sensor_OTP_read(0x021f);     //0220  20160524
    break;
    case 0x03:
    ...
    infocheck = HI843B_Sensor_OTP_read(0x0230);     //0231  20160524
    break;
    default:
	...
	switch (wb_flag)
	{
		case 0x01:  //Group1 valid
		   ...
		   // wb_golden_g_l = HI843B_Sensor_OTP_read(0x0c77);
			wbcheck = HI843B_Sensor_OTP_read(0x0210);
		...
		case 0x02:  //Group2 valid
		   ...
		   // wb_golden_g_l = HI843B_Sensor_OTP_read(0xBD51);
		    wbcheck = HI843B_Sensor_OTP_read(0x0221);
			for(i=0;i < 12;i++)
			{
				addr = 0x0c7e + i;
		...
		case 0x03:  //Group3 valid
		  ...
		  //  wb_golden_g_l = HI843B_Sensor_OTP_read(0xBD8A);
		    wbcheck = HI843B_Sensor_OTP_read(0x0232);
			for(i=0;i < 12;i++)
			{
				addr = 0x0c9c + i;
...
//  wb_golden_bg_l = 0x09;//
 ...
 //     + wb_golden_r_h + wb_golden_r_l + wb_golden_b_h + wb_golden_b_l + wb_golden_g_h + wb_golden_g_l ) % 0xFF + 1;
	...
	checksum = (wb_unit_rg_h + wb_unit_rg_l + wb_unit_bg_h + wb_unit_bg_l) % 255 + 1;
	...
	rg_golden_value = 0x110;// ((wb_golden_rg_h << 8)|wb_golden_rg_l);  //0x0278
	bg_golden_value = 0x124;// ((wb_golden_bg_h << 8)|wb_golden_bg_l);  //0x0252
...
write_cmos_sensor(0x0a00, 0x0000); //steam on
