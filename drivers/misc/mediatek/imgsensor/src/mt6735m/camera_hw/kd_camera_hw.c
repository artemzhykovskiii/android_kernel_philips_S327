...
#define VOL_1000 1000000
	...
	if (On) {
		...
		if ((currSensorName && (0 == strcmp(currSensorName, "imx135mipiraw"))) ||
		...
		else if ((pinSetIdx == 0 && currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI846_MIPI_RAW, currSensorName))) || (pinSetIdx == 0 && currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI843_MIPI_RAW, currSensorName))) ) {
			...
			/* disable sub sensor */
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(1, CAMPDN,pinSet[1][7]);
			
				mdelay(2);
			
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST])
				mtkcam_gpio_set(1, CAMRST,pinSet[1][3]);
			...
			mdelay(20);
		...
		else if ((pinSetIdx == 1 && currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI553_MIPI_RAW, currSensorName)))||(pinSetIdx == 1 && currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI553A_MIPI_RAW, currSensorName)))  ) {
					//mtkcam_gpio_set(pinSetIdx, CAMLDO, 1);
					...
					/* disable main sensor */
					if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN])
						mtkcam_gpio_set(0, CAMPDN,pinSet[0][7]);
					
						mdelay(2);
					
					if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST])
						mtkcam_gpio_set(0, CAMRST,pinSet[0][3]);
